...
class OrderPage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.priceCeil = page.locator('span.cursor-pointer.c');
        this.priceFloor = page.locator('span.cursor-pointer.f');
        this.priceReference = page.locator('span.cursor-pointer.r');
